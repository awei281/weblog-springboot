...
public class UserController {
    ...
    public Response<Boolean> updatePassword(@RequestBody @Valid UserUpdReqVO reqVO) {
        log.info("更新密码请求参数: {}", reqVO);
    ...
    public Response<IPage<UserRespVO>> getUserPage(@RequestBody @Valid UserPageReqVO pageReqVO) {
        return Response.success(userService.getUserPage(pageReqVO));
    }
